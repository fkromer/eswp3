...
# -*- coding: utf-8 -*-
#
# ESWKMS documentation build configuration file, created by
...
sys.path.append(os.path.abspath('exts/sphinxcontrib-p3/sphinxcontrib'))
...
exclude_patterns = ['_build', 'venv*', 'p3*', 'exts/*']
...
html_use_opensearch = 'http://eswp3.readthedocs.org/en/latest'
